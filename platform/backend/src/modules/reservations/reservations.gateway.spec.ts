...
describe('ReservationsGateway', () => {
  ...
  describe('joinRestaurant', () => {
    it('should join restaurant room when client is authenticated', () => {
      const mockSocket = createMockSocket({
        user: { id: 'user-123', email: 'test@example.com', roles: ['MAITRE'] },
      });
  ...
  describe('notify methods', () => {
    it('should emit reservation:created to restaurant room via notifyReservationCreated', () => {
    ...
    it('should emit reservation:updated to both restaurant and user rooms via notifyReservationUpdated', () => {
      const reservation = {
        id: 'reservation-1',
