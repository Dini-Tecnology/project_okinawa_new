...
with_node \
  ...
  --target "/Users/avantar/Desktop/Projetos/BRNDev/project_okinawa_new/platform/mobile/apps/restaurant/ios/Pods/Target Support Files/Pods-NooweRestaurante/ExpoModulesProvider.swift" \
  --entitlement "/Users/avantar/Desktop/Projetos/BRNDev/project_okinawa_new/platform/mobile/apps/restaurant/ios/NooweRestaurante/NooweRestaurante.entitlements" \
   \
  --platform "apple" \
  --packages "expo" "expo-apple-authentication" "expo-application" "expo-asset" "expo-blur" "expo-camera" "expo-constants" "expo-crypto" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-local-authentication" "expo-location" "expo-notifications" "expo-router" "expo-secure-store" "expo-sharing" "expo-web-browser"
