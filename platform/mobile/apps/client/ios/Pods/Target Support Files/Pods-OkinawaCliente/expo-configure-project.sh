...
with_node \
  ...
  --target "/Users/avantar/Desktop/Projetos/BRNDev/project_okinawa_new/platform/mobile/apps/client/ios/Pods/Target Support Files/Pods-OkinawaCliente/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-apple-authentication" "expo-application" "expo-asset" "expo-blur" "expo-camera" "expo-constants" "expo-crypto" "expo-device" "expo-file-system" "expo-font" "expo-haptics" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-local-authentication" "expo-router" "expo-secure-store" "expo-sharing" "expo-system-ui" "expo-web-browser"
